  ...
  return (
    <>
      <div className="w-full mx-auto lg:w-10/12 m-10 p-10">
        <div className="grid grid-cols-1 xl:grid-cols-3 lg:grid-cols-3 md:grid-cols-3 ">
          <div className="custom-card-image p-3 shadow-md mb-6 md:mb-0">
            <img src={mrt} alt="" />
          </div>

          <div className="col-span-2 p-3 mx-6">
            <div className="mb-6">
              <h1 className="text-3xl card-title">ko</h1>
            ...
            <div>
              <span class="inline-flex items-center m-2 px-3 py-1 bg-green-200 hover:bg-green-300 rounded-full text-sm font-semibold text-green-600">
                ...
                <span class="ml-1">Success Badge</span>
              </span>
